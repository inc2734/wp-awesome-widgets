...
<?php echo wp_kses_post( $widget_args['before_widget'] ); ?>
	...
	<div
		...
		echo do_shortcode(
			sprintf(
				'[wp_contents_outline post_id="%1$d" selector=".c-entry__content, .c-entry__content .wp-block-group, .c-entry__content .wp-block-group__inner-container" display_before_first_heading="false" headings="%2$s" title="%3$s"]',
				get_the_ID(),
