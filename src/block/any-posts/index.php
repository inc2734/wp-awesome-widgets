 ...
 * editor_script
 */
$asset = include( get_template_directory() . '/vendor/inc2734/wp-awesome-widgets/src/assets/block/any-posts/editor.asset.php' );
wp_register_script(
	'wp-awesome-widgets/any-posts/editor',
	get_template_directory_uri() . '/vendor/inc2734/wp-awesome-widgets/src/assets/block/any-posts/editor.js',
	array_merge( $asset['dependencies'], [ 'wp-awesome-widgets-editor' ] ),
	filemtime( get_template_directory() . '/vendor/inc2734/wp-awesome-widgets/src/assets/block/any-posts/editor.js' ),
	true
);
...
register_block_type(
	__DIR__,
	[
		'editor_script'   => 'wp-awesome-widgets/any-posts/editor',
